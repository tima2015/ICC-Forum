...
$lang = array_merge($lang, [
	...
	'LINK'					=> 'Ссылка',
	'LIMIT_SUBFORUMS'			=> 'Показывать в списке только собственные подфорумы',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Ограничивает список подфорумов только теми, для которых данный форум непосредственно является родительским (первого уровня вложенности). При отключении данной опции в списке будут отображены все подфорумы данного форума (незавимисо от уровня вложенности), для которых включена настройка «Показывать форум в списке подфорумов».',
